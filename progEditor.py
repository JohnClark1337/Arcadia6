...
class Ui_frmXMLEdit(object):
    def setupUi(self, frmXMLEdit):
        ...
        frmXMLEdit.setMinimumSize(QtCore.QSize(692, 467))
        frmXMLEdit.setMaximumSize(QtCore.QSize(692, 467))
        icon = QtGui.QIcon()
        ...
        self.lstCurrent.setMinimumSize(QtCore.QSize(301, 301))
        self.lstCurrent.setMaximumSize(QtCore.QSize(301, 301))
        self.lstCurrent.setSelectionMode(QtWidgets.QAbstractItemView.NoSelection)
        ...
        self.btnReset.setGeometry(QtCore.QRect(630, 0, 41, 23))
    ...
    def retranslateUi(self, frmXMLEdit):
        ...
        self.btnReset.setText(_translate("frmXMLEdit", "Reset"))
